...
class RawProcess:
    def __init__(self, device, data_path, data_name):
        ...
        # Use relative path to vosk model in simple_processor directory
        current_dir = os.path.dirname(os.path.abspath(__file__))
        vosk_model_path = os.path.join(current_dir, "vosk-model-en-us-0.22")
    ...
    def preprocess(self, video_path):
        ...
        if not success:
            print("Facial landmark detection failed - returning None")
            return None
